...
/**
 * Servlet implementation class GetDiseaseByUnifiedSearch
 */
@WebServlet(description = "Given a disease conditionName this endpoint will return all information for the disease", urlPatterns = { "/api/disease/unified/search" })
public class GetDiseaseByUnifiedSearch extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetDiseaseByUnifiedSearch() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String diseaseSearchParam = request.getParameter("diseaseSearchParam");
		
		if (diseaseSearchParam == null) {
			JSONObject errorMsg = new JSONObject();
			errorMsg.put("success", false);
			errorMsg.put("msg_header", "Unified Search");
			errorMsg.put("msg_body", "diseaseSearchParam parameter missing");
		...
		List<Disease> diseases = DiseaseDAO.getDiseasesByUnifiedSearch(diseaseSearchParam);
